                        ...
                        <div className = "relative">
                            ...
                            <form>
                                <div className ="flex flex-none flex-col">
                                    ...
                                    <input type="text" placeholder= "Mi publicacion..." className="border w-3/4 mb-10 m-auto p-2 text-md" required></input>
                                    <p className ="w-max text-lg font-bold m-auto mb-1"> Descripción</p>
                                    <input type="text" placeholder= "Lorem ipsum..." className="border w-3/4 mb-10 m-auto p-2 text-md"></input>
                                    <p className ="w-max text-lg font-bold m-auto mb-1"> Imagen</p>
                                    <input type="text" placeholder= "Url de la imagen..." className="border w-3/4 mb-10 m-auto p-2 text-md" required></input>
                                    <button className = "m-auto w-1/2 lg:w-1/3 transition rounded border border-blue-500 duration-300 ease-in-out text-lg text-extrabold uppercase bg-blue-500 hover:bg-blue-700 py-2 px-4 text-gray-100"> Enviar! </button>
                                </div>
                            </form>
                        </div> 
                    </div>
