...
export default function Admin() {
    ...
    return (
        <section className="flex flex-col justify-center items-center min-h-screen min-w-scren">
            ...
            <button onClick={ownedHandler} className="fixed bottom-5 right-2 uppercase w-max w-max transition rounded border border-blue-500 duration-300 ease-in-out lg:text-lg text-sm text-extrabold bg-blue-500 hover:bg-blue-600 py-2 px-4 text-white">Ver mis posts</button>
